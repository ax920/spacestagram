...
export default function Post(props) {
    ...
    const [likedState, setLikedState] = useState("Like");
    function toggleLike() {
        if (likedState === "Like") {
    ...
    return (
        <div className="wrapper animated animatedFadeInUp fadeInUp">
            <div className="post-wrapper">
                ...
                <img className="post-img" src={props.url}></img>
                <span className="post-info-wrapper">
                    <span className="like-container" onClick={() => {toggleLike()}}>
                        <p className="like-text">{likedState}</p>
